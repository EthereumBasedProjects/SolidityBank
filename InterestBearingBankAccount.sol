...
interface cETH {
    ...
    function balanceOf(address owner) external view returns (uint256 balance); // Gets cETH Token Balance of Given Address
}
...
contract InterestBearingBankAccount {
    ...
    function getBalance(address userAddress) public view returns(uint) {
        ...
        return ceth.balanceOf(userAddress) * ceth.exchangeRateStored() / 1e18; // Compound exchange rate is scaled by 1e18
